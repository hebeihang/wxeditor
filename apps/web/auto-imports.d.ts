...
declare global {
  ...
  const outlineSettings: typeof import('./src/stores/outlineSettings').default
  ...
  const useOutlineSettings: typeof import('./src/stores/outlineSettings').useOutlineSettings
  ...
  const useWordStyleStore: typeof import('./src/stores/word-style').useWordStyleStore
...
declare global {
  ...
  // @ts-ignore
  export type { WordStyleId, WordStylePreset } from './src/stores/word-style'
  import('./src/stores/word-style')
  // @ts-ignore
