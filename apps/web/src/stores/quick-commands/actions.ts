...
export const ACTION_TRANSLATE_ZH: QuickCommandPersisted = { id: `action:translate-zh`, label: `翻译成中文`, template: `请将以下内容翻译为地道中文，保留专有名词、术语不误译：\n\n{{sel}}` }
export const ACTION_TRANSLATE_EN: QuickCommandPersisted = { id: `action:translate-en`, label: `翻译成英文`, template: `Please translate the following content into natural English. Keep proper nouns and domain terms consistent:\n\n{{sel}}` }
