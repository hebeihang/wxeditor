...
_Completamente gratis · Procesamiento local · 18+ temas profesionales · 23 idiomas_
...
Encabezados · Párrafos · Negrita · Cursiva · Tachado · Listas · Listas de tareas · Citas · Bloques de código (100+ lenguajes resaltados) · Tablas · Enlaces · Imágenes · Diagramas Mermaid · Gráficos Vega/Vega-Lite · Fórmulas LaTeX · HTML · Extensiones GFM
...
R: Todos los diagramas Mermaid (flujo, secuencia, gantt, clase, estado, circular, ER, etc.), gráficos de visualización de datos Vega/Vega-Lite + auto-conversión SVG.
...
_Completamente Gratis · Procesamiento Local · Privacidad Protegida_
