...
Títulos · Parágrafos · Negrito · Itálico · Tachado · Listas · Listas de tarefas · Citações · Blocos de código (destaque de 100+ linguagens) · Tabelas · Links · Imagens · Diagramas Mermaid · Gráficos Vega / Vega-Lite · Fórmulas LaTeX · HTML · Extensões GFM
...
R: Todos os diagramas Mermaid (fluxogramas, diagramas de sequência, gráficos de Gantt, diagramas de classe, diagramas de estado, gráficos de pizza, diagramas ER, etc.), gráficos de visualização de dados Vega / Vega-Lite + conversão automática de SVG.
