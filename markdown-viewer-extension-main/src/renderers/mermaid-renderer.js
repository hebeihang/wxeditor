...
export class MermaidRenderer extends BaseRenderer {
  ...
  async render(code, themeConfig, extraParams = {}) {
    ...
    if (viewBox) {
      ...
      captureWidth = Math.ceil(Number.parseFloat(svgElement.getAttribute('width')) || 800)
      captureHeight = Math.ceil(Number.parseFloat(svgElement.getAttribute('height')) || 600)
    }
