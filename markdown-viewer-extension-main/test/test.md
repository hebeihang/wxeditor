...
混合格式测试：**粗体中包含 _斜体_ 文字**，~~删除线中包含 **粗体**~~
...
**转义字符测试：** \*不是斜体\* \`不是代码\` \# 不是标题 \[不是链接\](test)
...
_注：SVG 和 Data URL 图片的详细测试在第 8 节_
...
const base64EncodedData =
  "SGVsbG9Xb3JsZEhlbGxvV29ybGRIZWxsb1dvcmxkSGVsbG9Xb3JsZEhlbGxvV29ybGRIZWxsb1dvcmxkSGVsbG9Xb3JsZEhlbGxvV29ybGRIZWxsb1dvcmxkSGVsbG9Xb3JsZEhlbGxvV29ybGRIZWxsb1dvcmxkSGVsbG9Xb3JsZEhlbGxvV29ybGRIZWxsb1dvcmxkSGVsbG9Xb3JsZA==";
...
**超长文本行：**
这是一个非常非常非常非常非常非常非常非常非常非常非常非常非常非常非常非常非常非常非常非常非常非常非常非常非常非常非常非常非常非常非常非常非常非常非常非常非常非常非常非常长的文本行，用于测试文本的自动换行和布局处理能力，包含中文字符和 English characters 以及 1234567890 数字和!@#$%^&\*()特殊符号。

**嵌套格式：**
**_~~`这是嵌套的格式化文本，包含粗体、斜体、删除线和代码`~~_**
